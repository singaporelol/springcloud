package com.ste.symphony.config;
...
public class MqttConfig {
    ...
    public MqttPahoClientFactory mqttClientFactory() {
        ...
        // 设置代理端的URL地址，可以是多个
        options.setServerURIs(new String[]{"tcp://192.168.2.100:1883"});
        options.setUserName("itcast");
    ...
    public MqttPahoClientFactory mqttOutboundClientFactory() {
        ...
        // 设置代理端的URL地址，可以是多个
        options.setServerURIs(new String[]{"tcp://192.168.2.100:1983"});
        factory.setConnectionOptions(options);
        return factory;
    }
...
//        defaultPahoMessageConverter.setPayloadAsBytes(true);
    ...
    public MessageHandler handler() {
        return message -> {
            ...
            if (topic.matches(".+/sensor")) { // 匹配：1/sensor
                ...
                mqttGateway.sendToMqtt(topic, 1, payload+"Additional Information");
    ...
    public MessageHandler outbound() {
        ...
        MqttPahoMessageHandler messageHandler = new MqttPahoMessageHandler("publishClient", mqttOutboundClientFactory());
